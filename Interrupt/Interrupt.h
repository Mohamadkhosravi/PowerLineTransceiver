...
//                                         Priority 
#define PLT_COMPAIR0_ISR_ADDRESS   0x04 // 0 High
#define EXTERNAL_PIN0_ISR_ADDRESS  0x08 // 1
#define EXTERNAL_PIN1_ISR_ADDRESS  0x0c // 2
#define USIM_ISR_ADDRESS           0x10 // 3      Universal Serial Interface
#define LVD_ISR_ADDRESS            0x14 // 4      Low Voltage Detector
#define ADC_ISR_ADDRESS            0x18 // 5      Analog to Digital Converter
#define EEPROM_ISR_ADDRESS         0x1c // 6
#define PTM_COMPAIR_P_ISR_ADDRESS  0x20 // 7
#define PTM_COMPAIR_A_ISR_ADDRESS  0x24 // 8
#define STM_COMPAIR_P_ISR_ADDRESS  0x28 // 9
#define STM_COMPAIR_A_ISR_ADDRESS  0x2c // 10
#define BASE_TIMER0_ISR_ADDRESS    0x30 // 11
#define BASE_TIMER1_ISR_ADDRESS    0x34 // 12
#define PLT_COMPAIR1_ISR_ADDRESS   0x38 // 13 LOW
